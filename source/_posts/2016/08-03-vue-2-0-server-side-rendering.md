...
Run `webpack` we'll get a *dist/bundle.js* file as the server-side bundle which can be read in server-side.
...
First of all, we have to change the above example to an express server:
